"""Snakemake script for the per-chip Planet order-manifest phase."""
...
def main_fetch_ps_chip_manifest(snakemake):
    """Build the per-chip order manifest from one snakemake job context."""
    path_d = {
    ...
    batch_mod.main_fetch_ps_chip_manifest(path_d=path_d, search_d=search_d, planet_d=planet_d, run_d=run_d)


if "snakemake" in globals():
    main_fetch_ps_chip_manifest(snakemake)
